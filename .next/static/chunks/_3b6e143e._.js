    ...
    const onSubmit = async (e)=>{
        ...
        try {
            ...
            if (!res.ok || !data.ok) {
                ...
                if ((data === null || data === void 0 ? void 0 : data.errors) && typeof data.errors === "object") {
                    setErrors((p)=>({
                            ...p,
                            ...data.errors,
                    ...
                    setErrors((p)=>({
                            ...p,
                            _root: (data === null || data === void 0 ? void 0 : data.error) || "Server error"
                        }));
                }
                return;
            }
...
_s(SmartBotConnect, "T0xylj7yH7hwTz5A3xyicmEx144=");
_c = SmartBotConnect;
var _c;
